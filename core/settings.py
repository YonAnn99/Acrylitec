...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', 'web-production-4f3c1.up.railway.app']
CSRF_TRUSTED_ORIGINS = ['https://web-production-4f3c1.up.railway.app']
...
if DATABASE_URL:
    ...
    # LOCAL — SQLite automático, sin instalar nada
    DATABASES = {
        'default': {
